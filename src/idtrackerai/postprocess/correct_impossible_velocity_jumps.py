...
def reassign(
    ...
    identities_outside_exclusive_roi = {
        identity + 1
        for identity in range(list_of_fragments.n_animals)
        if list_of_fragments.id_to_exclusive_roi[identity] != fragment.exclusive_roi
    }
    identities_outside_exclusive_roi = set(
