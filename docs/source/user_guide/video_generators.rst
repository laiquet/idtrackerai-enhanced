...
.. admonition:: Pose estimation
    ...
    Individual videos can be useful to extract animal pose information with softwares like, for example, :external:`SLEAP <https://sleap.ai/>` and :external:`DeepLabCut <http://www.mackenziemathislab.org/deeplabcut/>`.
