...
.. admonition:: DeepLabCut
    ...
    Individual videos can be useful to extract animal pose information with softwares like, for example, :external:`DeepLabCut <http://www.mackenziemathislab.org/deeplabcut/>`.
