...
The :ref:`segmentation app`, the :ref:`validator` and the :ref:`video generator` do **not** require Pytorch and, hence, they do not need a dedicated graphics device. You can use these tools by installing **only** the steps 1 to 3 of :ref:`install idtracker.ai`.
